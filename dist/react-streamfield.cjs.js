...
var AddButton = (_dec = reactRedux.connect(function (state, props) {
...
var NestedBlockHeader = (_dec$1 = reactRedux.connect(function (state, props) {
  var fieldId = props.fieldId,
      blockId = props.blockId;
  var fieldData = state[fieldId];
  var blocks = fieldData.blocks;
...
var _dec$2, _class$2;
var FieldInput = (_dec$2 = reactRedux.connect(function (state, props) {
  var fieldId = props.fieldId,
      blockId = props.blockId;
...
var StructChildField = (_dec$3 = reactRedux.connect(function (state, props) {
  var fieldId = props.fieldId,
...
var _dec$4, _class$4;
var StructChildFieldWithTabs = (_dec$4 = reactRedux.connect(function (state, props) {
  var fieldId = props.fieldId,
      blockId = props.blockId;
  var fieldData = state[fieldId];
  var blocks = fieldData.blocks;
...
function (_React$Component) {
  ...
  _createClass(StructChildFieldWithTabs, [{
    ...
    value: function render() {
      ...
      }, React.createElement(reactTabs.Tabs, null, React.createElement(reactTabs.TabList, null, tabList), tabPanel));
    }
  }]);
...
var _dec$5, _class$5;
var BlockContent = (_dec$5 = reactRedux.connect(function (state, props) {
  var fieldId = props.fieldId,
      blockId = props.blockId;
  var fieldData = state[fieldId];
  var blocks = fieldData.blocks;
...
var BlockActions = (_dec$6 = reactRedux.connect(function (state, props) {
  var fieldId = props.fieldId,
      blockId = props.blockId;
  var blockDefinition = getNestedBlockDefinition(state, fieldId, blockId);
...
var BlockHeader = (_dec$7 = reactRedux.connect(function (state, props) {
  var fieldId = props.fieldId,
      blockId = props.blockId;
  var fieldData = state[fieldId];
  var blocks = fieldData.blocks;
...
var Block = (_dec$8 = reactRedux.connect(function (state, props) {
  var fieldId = props.fieldId,
      id = props.id;
  var fieldData = state[fieldId];
  var blocks = fieldData.blocks;
...
var _dec$9, _class$9;
var BlocksContainer = (_dec$9 = reactRedux.connect(function (state, props) {
  var fieldId = props.fieldId,
      id = props.id;
  var fieldData = state[fieldId];
...
var StreamField = (_dec$a = reactRedux.connect(function (state, props) {
  var id = props.id;
...
exports.StreamField = StreamField;
exports.streamFieldReducer = reducer;
